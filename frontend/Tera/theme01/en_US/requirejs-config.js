...
var config = {
    map: {
        '*': {
            'shoppingCoach': 'Tera_AffiliateProducts/js/product/view/shopping-coach'
        }
    }
};
    ...
    'config': {
        'mixins': {
            'Magento_Checkout/js/view/progress-bar': {
                'Tera_Checkout/js/view/progress-bar-mixin': true
            },
            'Magento_Checkout/js/view/sidebar': {
                'Tera_Checkout/js/view/sidebar-mixin': true
            },
            'Magento_Checkout/js/view/summary': {
                'Tera_Checkout/js/view/summary-mixin': true
            },
            'Magento_Checkout/js/view/billing-address': {
                'Tera_Checkout/js/view/billing-address-mixin': true
            },
            'Magento_Ui/js/model/messages': {
                'Tera_Checkout/js/model/messages-mixin': true
            },
        },
    }
}
...
var config = {
    map: {
        '*': {
            howToUseVideo: 'Tera_Kits/js/how-to-use-video',
        }
    }
};
	...
	config: {
        mixins: {
            'Magento_Checkout/js/sidebar': {
                'Tera_MiniCart/js/sidebar': true
            }
        }
    },
    map: {
        '*': {
            'Magento_Checkout/template/minicart/item/default.html': 'Tera_MiniCart/template/minicart/item/default.html'
        }
    }
};
...
(function() {
/**
 * Copyright © WebProvise, Inc. All rights reserved.
 * See COPYING.txt for license details.
 */
...
var config = {
    map: {
        '*': {
            wpShopByBrandValues: 'WP_Settings/js/view/shop-by-brand-values',
            wpShopByCategory: 'WP_Settings/js/view/shop-by-category',
            eventManager: 'WP_Settings/js/event-manager',
            dataStorage: 'WP_Settings/js/data-storage',
            viewCounter: 'WP_Settings/js/view-counter'
        }
    },
    config: {
        mixins: {
            'mage/validation': {
                'WP_Settings/js/validation-mixin': true
            }
        }
    }
};
    ...
    config: {
        mixins: {
            'Magento_ProductVideo/js/fotorama-add-video-events': {
                'WP_Brand/js/fotorama-add-video-events-mixin': true
            }
        }
    },
    map: {
        '*': {
            brandComments: 'WP_Brand/js/view/comments'
        }
    }
};
...
var config = {
    map: {
        '*': {
            newHtuVideoDialog:  'WP_Product/js/new-htu-video-dialog',
            openHtuVideoModal:  'WP_Product/js/htu-video-modal'
        }
    },
    config: {
        mixins: {
            'Webkul_Marketplace/js/product-gallery': {
                'WP_Product/js/product-gallery-mixin': true
            }
        }
    }
};
...
var config = {
    'config': {
        'mixins': {
            'Magento_Checkout/js/view/shipping': {
                'WP_Checkout/js/view/shipping-payment-mixin': true
            },
...
var config = {
    ...
    map: {
        '*': {
            'advancedTabs': 'WP_Npo/js/advanced-tabs',
            'npoList': 'WP_Npo/js/view/category/npo'
        }
    }
};
...
var config = {
    config: {
        mixins: {
            'Magento_Theme/js/view/breadcrumbs': {
                'WP_Blog/js/post/breadcrumbs': true
            }
        }
    }
};
 ...
 */
 ...
 var config = {
    map: {
        '*': {
            editProfile: 'Webkul_MpVendorRegistration/js/editprofile',
            displayVendorFields: 'Webkul_MpVendorRegistration/js/display-vendor-fields',
        }
    }
};
...
var config = {
    config: {
        mixins: {
            'Webkul_Marketplace/js/new-video-dialog': {
                'WP_MarketPlace/js/new-video-dialog-mixin': true
            },
            'Webkul_Marketplace/js/account/verify-seller-shop': {
                'WP_MarketPlace/js/account/verify-seller-shop-mixin': true
            }
        }
    }
};
...
var config = {
    map: {
        '*': {
            stripejs: 'https://checkout.stripe.com/checkout.js',
            stripeConnectJs: 'Webkul_MpRecurringPayment/js/stripeConnectJs',
            customAccount: 'Webkul_MpRecurringPayment/js/customAccount'
        }
    }
};
...
var config = {
    paths: {
        ...
        customScrollbar: 'js/mCustomScrollbar.min',
    ...
    shim: {
        ...
        'customScrollbar': {
            ...
            exports: 'jQuery.fn.customScrollbar'
        },
        'Magento_Theme/js/theme': {
            deps: ['slick', 'dotdotdot', 'mage/smart-keyboard-handler']
        },
        'Magento_Theme/js/responsive': {
            deps: ['customScrollbar']
        }
    },
    deps: ['js/custom']
};
...
var config = {
    paths: {
        selectize: 'Tera_CarbonCalculator/js/selectize.min',
        select2: 'Tera_CarbonCalculator/js/select2'
    },
    shim: {
        'selectize': {
            deps: ['jquery']
    ...
    deps: [
        'Tera_CarbonCalculator/js/carbon',
        'Tera_CarbonCalculator/js/results'
    ]
};
require.config(config);
})();
